    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(default='default/accounts_default.PNG', upload_to=accounts.models.photo_dir, verbose_name='Photo')),
                ('is_active', models.BooleanField(default=True, verbose_name='Status active')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Status staff')),
